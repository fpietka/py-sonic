...
class Connection(object):
    ...
    def getLicense(self):
        ...
        return self._getRequest(viewName)
    ...
    def getIndexes(self, musicFolderId=None, ifModifiedSince=0):
        ...
        return self._getRequest(viewName, q)
    ...
    def getMusicDirectory(self, mid):
        ...
        return self._getRequest(viewName, {'id': mid})
    ...
    def getPlaylist(self, pid):
        ...
        return self._getRequest(viewName, {'id': pid})
    ...
    def createPlaylist(self, playlistId=None, name=None, songIds=[]):
        ...
        return self._getRequestWithList(viewName, 'songId', songIds, q)
    ...
    def download(self, sid):
        ...
        return self._getRequest(viewName, {'id': sid})
    ...
    def createShare(self, shids=[], description=None, expires=None):
        ...
        return self._getRequestWithList(viewName, 'id', shids, q)
    ...
    def _getRequest(self, viewName, query={}):
        ...
        url = '%s:%d/%s/%s' % (self._baseUrl, self._port, self._serverPath,
            viewName)
        return self._doReq(urllib2.Request(url, urlencode(qstring)))
    ...
    def _getRequestWithList(self, viewName, listName, alist, query={}):
        ...
        print data.getvalue()
        return self._doReq(urllib2.Request(url, data.getvalue()))
